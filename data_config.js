...
// ĐÃ GỠ: loại hồ sơ "Bản sao Giấy khai sinh" (doc_khaisinh) — trường dữ liệu này đã bị hủy ở repo 1
// (form nhập liệu không còn thu thập nữa), nên KHÔNG kiểm tra/không tính thiếu hồ sơ theo mục này.
const DICT_HO_SO = {
    chung: [
